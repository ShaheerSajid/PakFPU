...
add wave -noupdate -expand -subitemconfig {/tb/fp_add_inst/add_result.u_result -expand} /tb/fp_add_inst/add_result
...
add wave -noupdate /tb/fp_add_inst/fp_add_inst/res_exp
add wave -noupdate /tb/fp_add_inst/fp_add_inst/comb_exp
add wave -noupdate /tb/fp_add_inst/fp_add_inst/inf_cond
add wave -noupdate /tb/fp_add_inst/fp_add_inst/shamt
add wave -noupdate /tb/fp_add_inst/fp_add_inst/a_i
add wave -noupdate /tb/fp_add_inst/fp_add_inst/b_i
add wave -noupdate /tb/fp_add_inst/fp_add_inst/a_decoded
add wave -noupdate /tb/fp_add_inst/fp_add_inst/b_decoded
add wave -noupdate /tb/fp_add_inst/fp_add_inst/a_info
add wave -noupdate /tb/fp_add_inst/fp_add_inst/b_info
add wave -noupdate /tb/fp_add_inst/fp_add_inst/urnd_result_o
...
WaveRestoreCursors {{Cursor 1} {6124 ps} 0}
